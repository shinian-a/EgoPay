...
public class AdminController {
    ...
    public CommonRes saveSetting(HttpSession session,String user,String pass,String pid,String notifyUrl,String returnUrl,String key,String wxpay,String zfbpay,String close,String payQf){
        if (session.getAttribute("login")==null){
            return ResUtil.error("未登录");
        }
        return adminService.saveSetting(user, pass, pid, notifyUrl, returnUrl, key, wxpay, zfbpay, close, payQf);
    }
